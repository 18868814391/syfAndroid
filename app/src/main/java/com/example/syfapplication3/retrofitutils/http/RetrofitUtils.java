package com.example.syfapplication3.retrofitutils.http;

import com.example.syfapplication3.retrofitutils.http.api.StringApi;
import com.example.syfapplication3.retrofitutils.http.api.UpLoadApi;
import com.example.syfapplication3.retrofitutils.http.callback.DownLoadCallback;
import com.example.syfapplication3.retrofitutils.http.callback.ResponseCallback;
import com.example.syfapplication3.retrofitutils.http.callback.RetrofitStringCallback;
import com.example.syfapplication3.retrofitutils.http.callback.StringCallback;
import com.example.syfapplication3.retrofitutils.http.download.DownloadManager;
